...
//            let person: SSUPerson = SSUDirectoryBuilder.person(withFirstName: (classData?.firstName)!, andLastName: (classData?.lastName), in: SSUDirectoryModule.instance.context)
//            let controller: SSUDirectoryViewController = segue.destination as! SSUDirectoryViewController
...
//        
//        
//        //            let buildingDetailsVC = SSUMapBuildingDetailViewController.instantiateFromStoryboard
//        //            buildingDetailsVC().building = building
//        //            buildingDetailsVC().delegate = self as! SSUMapBuildingDetailDelegate
//        
//        
//        //            let storyboard = UIStoryboard(name: "Map_Building", bundle: nil)
//        //            navigationController?.pushViewController(storyboard.instantiateViewController(withIdentifier: "SSUMapBuildingDetailViewController"), animated: true)
//        
//    }
//    
//}
